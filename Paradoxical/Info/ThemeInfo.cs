...
{
    private const string TEXT_FILE = "Paradoxical.Resources.Lists.Themes.txt";

    public string Name { get; init; } = string.Empty;

    public static IEnumerable<ThemeInfo> ParseText()
    {
    ...
    public static IEnumerable<ThemeInfo> ParseText(string text)
    {
