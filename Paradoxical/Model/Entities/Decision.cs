...
public class Decision : IEntity, IModel, IElement, IEquatable<Decision?>
{
    ...
    {
        return $"{modService.GetPrefix()}_decision_{Id}";
    }
        ...
        IDecisionService decisionService)
    {
        ...
        writer.Indent().WriteLine($"confirm_text = {GetLocationKey(modService)}.c");
    ...
    private void WriteShown(
        ...
        IDecisionService decisionService)
    {
        var triggers = decisionService.GetShowns(this);
    ...
    private void WriteValid(
        ...
        IDecisionService decisionService)
    {
        var triggers = decisionService.GetValids(this);
        if (triggers.Any() == false)
        {
    ...
    private void WriteFailure(
        ...
        IDecisionService decisionService)
    {
        var triggers = decisionService.GetFailures(this);
        if (triggers.Any() == false)
        {
        ...
        IDecisionService decisionService)
    {
        ...
        writer.Indent().WriteLine($"trigger_event = {{ id = {triggeredEvent.GetQualifiedName(modService)} }}");
        ...
        IModService modService)
    {
        ...
        writer.WriteLocLine($"{GetLocationKey(modService)}.c", Confirm);
    }
